    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 border-t border-zinc-100">
        <div className="max-w-4xl mx-auto px-6 space-y-6 text-zinc-600 leading-relaxed">
          <p>
            As a founder, you need to move fast and stay lean. <Link href="/products/create" className="text-blue-600 hover:underline">Esteemed Create</Link> lets you build your first product or website in minutes using AI, so you can validate ideas before writing a single line of code. Deploy instantly on <Link href="/products/cloud" className="text-blue-600 hover:underline">Esteemed Cloud</Link> and start collecting feedback from day one.
          </p>
          <p>
