    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 border-t border-zinc-100">
        <div className="max-w-4xl mx-auto px-6 space-y-6 text-zinc-600 leading-relaxed">
          <p>
            IT directors are responsible for keeping systems running, budgets in check, and teams productive -- all while driving digital transformation. <Link href="/products/cloud" className="text-blue-600 hover:underline">Esteemed Cloud</Link> provides managed hosting with built-in security, monitoring, and compliance, reducing the operational burden on your team. Pair it with <Link href="/products/create" className="text-blue-600 hover:underline">Esteemed Create</Link> to empower business users to build internal tools and portals without consuming engineering cycles.
          </p>
          <p>
