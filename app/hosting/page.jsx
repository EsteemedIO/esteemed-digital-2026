...
export const metadata = {
  ...
  description:
    "Website hosting on Esteemed Cloud. Self-serve and managed plans for WordPress, Drupal, Next.js, and more. SSL, backups, monitoring, and support included.",
};
    ...
    <div className="min-h-screen">
      ...
      <div id="plans">
        ...
        <ProductPricingBlock
          ...
          description="Website hosting with SSL included and no forced CMS migration. Best for bring-your-own, Create-built, React, Node, and Next sites."
          productKey="cloud"
          plans={cloudPlans}
          ctaLabel="Buy Now"
