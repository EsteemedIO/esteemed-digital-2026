  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-ink py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Want to host an event with us?</h2>
          <p className="text-zinc-400 mb-8">We partner with organizations for webinars, workshops, and community events.</p>
          <Link
            href="/contact"
