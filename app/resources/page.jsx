  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-accent py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-ink mb-6">Need help choosing the right solution?</h2>
          <p className="text-zinc-700 mb-8">Our team can guide you to the right products and services for your needs.</p>
          <Link
            href="/contact"
