  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="px-6 py-10 md:py-16">
        <div className="mx-auto rounded-3xl pl-8 md:pl-14 pr-8 py-8 grid md:grid-cols-2 gap-10 items-center overflow-hidden" style={{ maxWidth: 1800, maxHeight: 640, background: "#E0E9F2" }}>
          <div>
            ...
            <p className="text-base text-zinc-600 leading-relaxed mb-4 max-w-lg">
              Our designers craft modern, responsive websites that reflect your brand and convert visitors into customers.
              Call (360) 701-7353 for a free consultation.
            </p>
            <ul className="space-y-1.5 mb-6 max-w-lg">
              {[
                "Personalized design that fits your budget",
                "You share the vision — we handle the build",
                "More time for your business, less on your site",
              ].map((item) => (
      ...
      {/* Service Plans + Contact Modal — Choose a Plan */}
      <ServicePlans />
      ...
      {/* Why Esteemed / Colleagues — split layout */}
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-ink mb-6">
                Backed by Esteemed Colleagues
              </h2>
