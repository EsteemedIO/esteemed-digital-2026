        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-sm font-medium text-zinc-500 mb-3">Hosting / Curate CMS</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link href="/signup?product=curate" className="inline-flex items-center justify-center px-8 py-4 rounded-full border-2 border-ink text-ink text-sm font-bold hover:bg-accent hover:border-accent transition-colors">
                  Provision Curate
                </Link>
              </div>
            </div>
