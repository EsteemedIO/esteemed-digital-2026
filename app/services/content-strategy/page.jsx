    ...
    <div className="min-h-screen">
      <section className="py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Compass className="mx-auto mb-6 h-14 w-14 text-ink" strokeWidth={1.5} />
          <p className="text-sm font-medium text-zinc-500 mb-4">Services</p>
          <h1 className="text-5xl md:text-6xl font-bold text-ink mb-6">
            Content Strategy
          </h1>
          <p className="text-lg text-zinc-600 max-w-2xl mx-auto leading-relaxed">
            Plan, align, and execute a content strategy that drives results. Powered by Esteemed Intelligence.
          </p>
        </div>
      </section>
