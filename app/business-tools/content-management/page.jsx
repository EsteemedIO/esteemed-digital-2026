        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/websites/hosting" className="inline-flex items-center justify-center rounded-full border-2 border-ink px-8 py-4 text-sm font-bold text-ink transition-colors hover:bg-accent hover:border-accent">
                View Cloud
              </Link>
            </div>
          </div>
