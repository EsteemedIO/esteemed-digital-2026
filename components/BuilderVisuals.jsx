...
/* Shared primitives */
function Pill({ w = 60, h = 8, c = "rgba(15,17,21,0.10)", r = 4 }) {
  return <div style={{ width: w, height: h, background: c, borderRadius: r }} />;
}

function Browser({ children, dark = false }) {
  return (
    <div
      style={{
        width: "100%",
...
/* 01 — Prompt to site (Build / Yellow) */
export function PromptToSite() {
  return (
    <div
      style={{
        width: "100%",
    ...
    >
      ...
      >
        <path
          d="M 4 4 Q 30 4 30 30 Q 30 56 56 56"
      ...
      <style>{`
        @keyframes bvBlink { 0%, 49% { opacity: 1 } 50%, 100% { opacity: 0 } }
        .bv-caret { animation: bvBlink 1s steps(1) infinite; }
      `}</style>
    </div>
  );
}

/* 02 — Drag-and-drop (Customize / Gray) */
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .bv-dragging { animation: bvDrift 2.4s ease-in-out infinite; }
        @keyframes bvNudge {
          0%, 100% { transform: translate(0, 0); }
          50% { transform: translate(-3px, -2px); }
        }
        .bv-cursor { animation: bvNudge 2.4s ease-in-out infinite; }
      `}</style>
    </div>
  );
}

/* 03 — Agent at work (Automate / Dark) */
export function CascadingAgent() {
  return (
    <div
      style={{
        width: "100%",
    ...
    >
      ...
      >
        ...
        {[
          { ic: "✓", t: "Analyzed 6 competitor sites" },
          { ic: "✓", t: "Generated brand palette" },
          { ic: "✓", t: "Wrote 4 page sections" },
          { ic: "◐", t: "Optimizing images…", active: true },
          ...
          >
            <span
              ...
              style={{
                ...
                justifyContent: "center",
                fontSize: 8,
                color: row.active ? INDIGO : "rgba(255,255,255,0.6)",
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 5,
                  background:
                    "linear-gradient(135deg, rgba(99,102,241,0.5), rgba(99,102,241,0.15))",
                }}
              />
            </div>
          </div>
      ...
      <style>{`
        ...
        .bv-spin { animation: bvSpin 1.4s linear infinite; }
        @keyframes bvPulse { 0%, 100% { opacity: 0.3 } 50% { opacity: 1 } }
        .bv-dot { animation: bvPulse 1.2s ease-in-out infinite; }
        @keyframes bvGrow { from { width: 58% } to { width: 66% } }
        .bv-progress { animation: bvGrow 2.4s ease-in-out infinite alternate; }
      `}</style>
    </div>
  );
}

/* 04 — Multi-device preview (Responsive / Paper) */
    ...
    >
      <div
        style={{
          ...
          height: "70%",
          background:
            "radial-gradient(closest-side, rgba(255,225,90,0.55), transparent)",
          filter: "blur(10px)",
        }}
      />
