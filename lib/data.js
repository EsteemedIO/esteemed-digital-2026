...
// AI agents
export const agents = [
  { key: "social", name: "Social Manager", price: 129, tagline: "Drafts and schedules posts in your voice across platforms", icon: Share2, description: "Drafts and schedules posts in your voice across platforms." },
  { key: "blog", name: "Blogger", price: 149, tagline: "Writes posts, articles, and newsletters in your voice", icon: FileText, description: "Writes posts, articles, and newsletters in your voice." },
  { key: "marketing", name: "Marketer", price: 199, tagline: "Email campaigns, automation, drip sequences in your voice", icon: Mail, description: "Email campaigns, automation, drip sequences in your voice." },
  { key: "recruiter", name: "Recruiter", price: 199, tagline: "Sources and engages talent in your voice (paired with Colleagues)", icon: UserSearch, description: "Sources and engages talent in your voice (paired with Colleagues)." },
];
...
export const agentFleet = {
  ...
  alacarte: 676,
  savings: 77,
  includesKeys: ["social", "blog", "marketing", "recruiter"],
};
