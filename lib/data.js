...
export const managedHostingTiers = [
  {
    ...
    supportHours: 2, description: "Done-for-you hosting for one site with two support hours per month.",
  },
  {
    ...
    supportHours: 5, description: "Managed hosting plus five support hours per month.",
  },
  {
    ...
    supportHours: 10, description: "Managed hosting plus ten support hours per month.",
  },
  {
    key: "enterprise", name: "Managed Enterprise", monthly: null, annual: null, lookupKey: "managed_enterprise_custom",
    supportHours: null, description: "Multi-site, dedicated infrastructure, SLA, and custom support.",
  },
];

// AI agents — launch-gated standalone add-ons. Curate Pro includes content agents by SKU entitlement.
export const agents = [
  { key: "receptionist", name: "AI Receptionist", price: 99, lookupKey: "agent_receptionist_monthly", tagline: "Star call-answering for hosted sites", icon: Phone, description: "Answers calls, captures intent, and routes follow-up.", launchGated: true },
  { key: "social", name: "Social", price: 129, lookupKey: "agent_social_monthly", tagline: "Repurposes and schedules social content", icon: Share2, description: "Repurposes approved content for social channels.", launchGated: true },
  { key: "blogger", name: "Blogger", price: 149, lookupKey: "agent_blogger_monthly", tagline: "Writes in your voice with SOnA training", icon: FileText, description: "Drafts posts, articles, and newsletters in your voice.", launchGated: true },
  { key: "marketer", name: "Marketer", price: 149, lookupKey: "agent_marketer_monthly", tagline: "Campaigns and marketing operations", icon: Mail, description: "Creates campaign drafts and campaign operations.", launchGated: true },
  { key: "recruiter", name: "Recruiter", price: 149, lookupKey: "agent_recruiter_monthly", tagline: "Sources and engages talent", icon: UserSearch, description: "Sources and engages talent in your voice.", launchGated: true },
  { key: "publicist", name: "Publicist", price: 149, lookupKey: "agent_publicist_monthly", tagline: "PR and public communications", icon: Share2, description: "Manages public communications drafts in your voice.", launchGated: true },
];
