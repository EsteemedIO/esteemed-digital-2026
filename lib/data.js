...
export const wooCommerceTiers = [
  {
    key: "starter", name: "Starter", monthly: 29, annual: 290, lookupKey: "woo_starter_monthly", annualLookupKey: "woo_starter_annual",
    description: "Managed WordPress + WooCommerce. 10GB storage, SSL, daily backups.",
    features: [
  ...
  {
    key: "growth", name: "Growth", monthly: 79, annual: 790, lookupKey: "woo_growth_monthly", annualLookupKey: "woo_growth_annual",
    recommended: true,
    description: "Staging environment, 25GB storage, WP-CLI, priority support.",
    features: [
  ...
  {
    key: "scale", name: "Scale", monthly: 199, annual: 1990, lookupKey: "woo_scale_monthly", annualLookupKey: "woo_scale_annual",
    description: "Dedicated resources, 100GB storage, Redis object cache, CDN.",
    features: [
  ...
  },
  {
    ...
    description: "Custom infrastructure, SLA, and dedicated support.",
    features: [
      "Everything in Scale",
      "Custom SLA",
...
export const drupalCommerceTiers = [
  {
    key: "starter", name: "Starter", monthly: 39, annual: 390, lookupKey: "drupal_starter_monthly", annualLookupKey: "drupal_starter_annual",
    description: "Managed Drupal + Commerce. 10GB storage, SSL, daily backups.",
    features: [
  ...
  {
    key: "growth", name: "Growth", monthly: 99, annual: 990, lookupKey: "drupal_growth_monthly", annualLookupKey: "drupal_growth_annual",
    recommended: true,
    description: "Staging environment, 25GB storage, Drush CLI, priority support.",
    features: [
      "Everything in Starter",
      "Staging environment",
      "25 GB storage",
  ...
  {
    key: "scale", name: "Scale", monthly: 249, annual: 2490, lookupKey: "drupal_scale_monthly", annualLookupKey: "drupal_scale_annual",
    description: "Dedicated resources, 100GB storage, Redis, Varnish cache.",
    features: [
      "Everything in Growth",
      "Dedicated compute resources",
      "100 GB storage",
