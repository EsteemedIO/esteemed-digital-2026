...
export const intelligenceProduct = {
  ...
  tiers: [
    {
      key: "trial", name: "Trial", monthly: 0, annual: 0, lookupKey: "intelligence_trial",
      basis: "14 days free",
      description: "Explore the full platform.",
      features: ["All 40 MCP tools", "Full REST API access", "250K memory operations", "3 connected agents", "Community support"],
    },
    {
      key: "builder", name: "Builder", monthly: 49, annual: 490, lookupKey: "intelligence_builder_monthly", annualLookupKey: "intelligence_builder_annual",
      basis: "Per tenant",
      recommended: true,
      description: "For individual developers and small teams.",
      features: ["All 40 MCP tools", "Full REST API access", "250K memory operations/mo", "Unlimited witnesses", "Bayesian beliefs", "Email support"],
    },
    {
      key: "pro", name: "Pro", monthly: 199, annual: 1990, lookupKey: "intelligence_pro_monthly", annualLookupKey: "intelligence_pro_annual",
      basis: "Per tenant",
      description: "For production workloads.",
      features: ["Everything in Builder", "2M memory operations/mo", "Reasoning endpoint", "FANN neural inference", "Custom embeddings", "Priority support", "SSO"],
    },
    {
      key: "scale", name: "Scale", monthly: 499, annual: 4990, lookupKey: "intelligence_scale_monthly", annualLookupKey: "intelligence_scale_annual",
      basis: "Per tenant",
      description: "For teams running at scale.",
      features: ["Everything in Pro", "Unlimited operations", "Unlimited clients", "Dedicated WASM tiles", "Custom coherence gates", "SLA guarantee", "Dedicated CSM"],
    },
    {
      key: "enterprise", name: "Enterprise", monthly: null, annual: null, lookupKey: "intelligence_enterprise_custom",
      basis: "Custom deployment",
      description: "On-premise or VPC deployment.",
      features: ["Everything in Scale", "Custom SLAs", "Dedicated infrastructure", "White-glove onboarding", "Core team access"],
    },
  ],
};
...
// VPS tiers — 65% markup on DigitalOcean Basic Droplets (Regular CPU).
export const vpsTiers = [
  {
    key: "vps-starter", name: "VPS Starter", monthly: 19.99, annual: 169,
    lookupKey: "vps_starter_monthly", annualLookupKey: "vps_starter_annual",
    description: "2 GB RAM, 1 vCPU, 50 GB NVMe SSD.",
    ram: "2 GB", vcpus: "1 vCPU", storage: "50 GB NVMe SSD", transfer: "2 TB",
  },
  {
    key: "vps-standard", name: "VPS Standard", monthly: 39.99, annual: 339,
    lookupKey: "vps_standard_monthly", annualLookupKey: "vps_standard_annual",
    description: "4 GB RAM, 2 vCPUs, 80 GB NVMe SSD.",
    ram: "4 GB", vcpus: "2 vCPUs", storage: "80 GB NVMe SSD", transfer: "4 TB",
    recommended: true,
  },
  {
    key: "vps-performance", name: "VPS Performance", monthly: 79.99, annual: 669,
    lookupKey: "vps_performance_monthly", annualLookupKey: "vps_performance_annual",
    description: "8 GB RAM, 4 vCPUs, 160 GB NVMe SSD.",
    ram: "8 GB", vcpus: "4 vCPUs", storage: "160 GB NVMe SSD", transfer: "5 TB",
  },
  {
    key: "vps-enterprise", name: "VPS Enterprise", monthly: 159.99, annual: 1339,
    lookupKey: "vps_enterprise_monthly", annualLookupKey: "vps_enterprise_annual",
    description: "16 GB RAM, 8 vCPUs, 320 GB NVMe SSD.",
    ram: "16 GB", vcpus: "8 vCPUs", storage: "320 GB NVMe SSD", transfer: "6 TB",
  },
];
...
export const heritage = [
  { year: "2011", event: "Drupal Contractors launches alongside Celebrate Drupal, connecting employers to top Drupal talent — growing to 600 vetted Drupal pros." },
  ...
  { year: "2019", event: "Esteemed is born. Drupal Contractors merges into Colleagues, creating the foundation for a 35,000-member talent network." },
  { year: "2024", event: "Esteemed Colleagues network reaches 35,000 active professional profiles. Esteemed Intelligence and Create launch." },
  { year: "Today", event: "Esteemed launches the AI+Human platform for work, combining 15 years of staffing, expanded hosting operations from our Digital division, and our suite of AI-driven applications including a Website builder, ATS, CRM, and Business Intelligence coherence engine." },
];
