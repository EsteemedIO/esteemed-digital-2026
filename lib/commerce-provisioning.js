...
export function generateAppSpec({ appId, tenantSlug, tier, registry, image, platform = "commerce" }) {
    ...
    services: [
      {
        ...
        envs: [
          ...(platform === "commerce" ? medusaEnvs(domain) : platform === "wordpress" ? wordpressEnvs() : drupalEnvs()),
