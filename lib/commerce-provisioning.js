...
export const DEFAULT_PLATFORM_IMAGES = {
  ...
  commerceStorefront: "esteemed/medusa-nextjs-starter:latest",
...
function medusaStorefrontEnvs(domain) {
  return [
    { key: "NODE_ENV", value: "production" },
    { key: "NEXT_PUBLIC_MEDUSA_BACKEND_URL", value: `https://${domain}` },
    { key: "NEXT_PUBLIC_BASE_URL", value: `https://${domain}` },
    { key: "NEXT_PUBLIC_DEFAULT_REGION", value: "us" },
  ];
}
...
export function generateAppSpec({
  ...
  registry,
  image,
  storefrontImage = DEFAULT_PLATFORM_IMAGES.commerceStorefront,
  platform = "commerce",
  cmsStorage,
}) {
      ...
      ? [
          {
            ...
            envs: [
              ...
              secretEnv("APP_SECRET", appSecret),
            ...
            routes: [{ path: "/store" }, { path: "/admin" }, { path: "/auth" }, { path: "/health" }],
            health_check: {
              http_path: "/health",
          ...
          },
          {
            ...
            image: imageSpec({ registry, image: storefrontImage }),
            instance_size_slug: specs.instanceSize,
            instance_count: specs.instanceCount,
            http_port: 8000,
            envs: [
              ...medusaStorefrontEnvs(domain),
              { key: "APP_URL", value: `https://${domain}` },
              { key: "ESTEEMED_APP_ID", value: appId },
              { key: "ESTEEMED_TENANT", value: tenantSlug },
              { key: "ESTEEMED_TIER", value: tier },
              { key: "ESTEEMED_PLATFORM", value: "medusa-nextjs-starter" },
            ],
            routes: [{ path: "/" }],
            health_check: {
              http_path: "/",
